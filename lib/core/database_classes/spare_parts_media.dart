class SparePartsMedia {
  ...
  factory SparePartsMedia.fromJson(Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) {
    ...
    return other is SparePartsMedia &&
...
List<SparePartsMedia> parseSparePartsMediaListItems(List<dynamic> jsoned) {
  return jsoned
      .map<SparePartsMedia>((item) => SparePartsMedia.fromJson(item))
      .toList();
}
